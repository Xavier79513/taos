                    ...
                    var n = function () {
                        ...
                        return function () {
                            ...
                            n && n.requirejs || (n ? t = n : n = {}, function (n) {
                                var r, o, s, a, l = {}, c = {}, u = {}, d = {}, p = Object.prototype.hasOwnProperty,
                                    h = [].slice, f = /\.js$/;
                                ...
                                function m(e, t) {
                                    var n, i, r, o, s, a, l, c, d, p, h, g = t && t.split("/"), m = u.map,
                                        v = m && m["*"] || {};
                                    if (e) {
                                        for (s = (e = e.split("/")).length - 1, u.nodeIdCompat && f.test(e[s]) && (e[s] = e[s].replace(f, "")), "." === e[0].charAt(0) && g && (e = g.slice(0, g.length - 1).concat(e)), d = 0; d < e.length; d++) if ("." === (h = e[d])) e.splice(d, 1), d -= 1; else if (".." === h) {
                                    ...
                                    if ((g || v) && m) {
                                        for (d = (n = e.split("/")).length; d > 0; d -= 1) {
                                            if (i = n.slice(0, d).join("/"), g) for (p = g.length; p > 0; p -= 1) if ((r = m[g.slice(0, p).join("/")]) && (r = r[i])) {
                                                o = r, a = d;
                                                break
                                            }
                                            if (o) break;
                                ...
                                s = function (e, t) {
                                    ...
                                    if (m = b(r = r || e), "undefined" === A || "function" === A) {
                                        for (t = !t.length && i.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1) if ("require" === (u = (h = s(t[f], m)).f)) $[f] = a.require(e); else if ("exports" === u) $[f] = a.exports(e), w = !0; else if ("module" === u) o = $[f] = a.module(e); else if (g(l, u) || g(c, u) || g(d, u)) $[f] = _(u); else {
                                    ...
                                    return t = t || function () {
                                    }, "function" == typeof i && (i = l, l = c), l ? r(n, e, t, i) : setTimeout((function () {
                                        r(n, e, t, i)
                                    }), 4), o
                                }, o.config = function (e) {
                                    return o(e)
                            ...
                            return t.Extend(n, t.Observable), n.prototype.render = function () {
                                ...
                                if (0 !== e.length) {
                                    var t = this.$results.find("[aria-selected]").index(e),
                                        n = this.$results.offset().top, i = e.offset().top,
                            ...
                            return t.Extend(i, e), i.prototype.bind = function (e, t) {
                                ...
                                for (var l = 0; l < e.length; l++) {
                                    ...
                                    if (n.inArray(c.id, o) >= 0) {
                                        var u = r.filter(a(c)), d = this.item(u), p = n.extend(!0, {}, c, d),
                                            h = this.option(p);
                                        u.replaceWith(h)
                                    } else {
                                        var f = this.option(c);
                            ...
                            return n.prototype.bind = function (e, t, n) {
                                ...
                                var a = this.$dropdown.outerHeight(!1), l = t.scrollTop(),
                                    c = t.scrollTop() + t.height(), u = l < o.top - a, d = c > o.bottom + a,
                                    p = {left: o.left, top: s.bottom}, h = this.$dropdownParent;
                            ...
                            return r.prototype.fromElement = function (e) {
                                ...
                                for (var s = 0; s < e[0].attributes.length; s++) {
                                    ...
                                    if (a.substr(0, 5) == l) {
                                        var c = a.substring(5), u = i.GetData(e[0], c);
                            ...
                            function l(i) {
                                var r = i || window.event, s = o.call(arguments, 1), l = 0, d = 0, p = 0, h = 0, f = 0,
                                    g = 0;
