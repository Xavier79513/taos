...
!function () {
    ...
    var s = {
        ...
        }, line: {series1: config.colors.warning, series2: config.colors.primary, series3: "#7367f029"}
    }, a = document.querySelector("#shipmentStatisticsChart"), r = {
        series: [{name: "Cerradas", type: "column", data: [15, 21, 30, 35, 31, 23, 19]}, {
            name: "Falsas",
            type: "line",
            data: [2, 4, 9, 8, 10, 5, 3]
        }],
        ...
        xaxis: {
            tickAmount: 10,
            categories: ["22 My", "23 My", "24 My", "25 My", "26 My", "27 My", "28 My"],
    ...
    }, a = (null !== a && new ApexCharts(a, r).render(), document.querySelector("#deliveryExceptionsChart")), r = {
        chart: {height: 420, parentHeightOffset: 0, type: "donut"},
        labels: ["Magdalena del Mar", "San Joaquin", "Media Luna", "Otros"],
        series: [34, 27, 22, 17],
                ...
                donut: {
                    ...
                    labels: {
                        ...
                        total: {
                            show: !0,
                            fontSize: "0.7rem",
                            label: "Incidentes por zona en el mes",
                            color: e,
                            formatter: function (e) {
                                return "30%"
                            }
    ...
    e.length && (e.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 2, responsivePriority: 1, render: function (e, t, s, a) {
            ...
            targets: 4, render: function (e, t, s, a) {
            ...
            targets: -1, render: function (e, t, s, a) {
                s = s.progress;
        ...
        responsive: {
            details: {
                ...
                }), type: "column", renderer: function (e, t, s) {
