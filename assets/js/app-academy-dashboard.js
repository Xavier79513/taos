...
!function () {
    ...
    const o = document.querySelector("#horizontalBarChart"), n = {
        ...
        xaxis: {
            ...
            axisTicks: {show: !1},
            labels: {
                style: {colors: e, fontSize: "13px"}, formatter: function (e) {
                    return e + "%"
                }
            }
        },
        yaxis: {max: 35, labels: {style: {colors: [e], fontFamily: "Public Sans", fontSize: "13px"}}},
        tooltip: {
            enabled: !0,
            style: {fontSize: "12px"},
    ...
    var i, t = document.querySelectorAll(".chart-progress"), s = (t && t.forEach(function (e) {
        var a = config.colors[e.dataset.color], s = e.dataset.series, t = e.dataset.progress_variant,
            a = (a = a, s = s, {
                chart: {
    ...
    s.length && (i = s.DataTable({
        ajax: assetsPath + "json/app-academy-dashboard.json",
        columns: [{data: ""}, {data: "id"}, {data: "course name"}, {data: "time"}, {data: "progress"}, {data: "status"}],
        columnDefs: [{
            className: "control",
            searchable: !1,
            orderable: !1,
            ...
            targets: 2, responsivePriority: 2, render: function (e, a, s, t) {
                var r = s.logo, o = s.course, n = s.user, i = s.image;
                return s = i ? '<img src="' + assetsPath + "img/avatars/" + i + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (i = (((i = s.user.match(/\b\w/g) || []).shift() || "") + (i.pop() || "")).toUpperCase()) + "</span>", '<div class="d-flex align-items-center"><span class="me-3">' + l[r] + '</span><div><a class="text-heading text-truncate fw-medium mb-2 text-wrap" href="app-academy-course-details.html">' + o + '</a><div class="d-flex align-items-center mt-1"><div class="avatar-wrapper me-2"><div class="avatar avatar-xs">' + s + '</div></div><span class="text-nowrap">' + n + "</span></div></div></div>"
            }
        }, {
            targets: 3, responsivePriority: 3, render: function (e, a, s, t) {
                var e = moment.duration(e), r = Math.floor(e.asHours());
                return '<span class="fw-medium text-nowrap">' + (r + "h " + (Math.floor(e.asMinutes()) - 60 * r) + "m") + "</span>"
            }
        }, {
            targets: 4, render: function (e, a, s, t) {
                var r = s.status;
                return '<div class="d-flex align-items-center gap-3"><p class="fw-medium mb-0">' + r + '</p><div class="progress w-100" style="height: 8px;"><div class="progress-bar" style="width: ' + r + '" aria-valuenow="' + r + '" aria-valuemin="0" aria-valuemax="100"></div></div><small class="text-muted">' + s.number + "</small></div>"
            }
        }, {
            targets: 5, render: function (e, a, s, t) {
                return '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="bx bx-user bx-xs me-2 text-primary"></i>' + s.user_number + '</div><div class="w-px-50 d-flex align-items-center"><i class="bx bx-book-open bx-xs me-2 text-info" ></i>' + s.note + '</div><div class="w-px-50 d-flex align-items-center"><i class="bx bx-video bx-xs me-2 text-danger" ></i>' + s.view + "</div></div>"
            }
        }],
        order: [[2, "desc"]],
        ...
        lengthMenu: [5],
        language: {sLengthMenu: "_MENU_", search: "", searchPlaceholder: "Course"},
        responsive: {
            details: {
                ...
                }), type: "column", renderer: function (e, a, s) {
